...
#if defined(CONFIG_MACH_ARUBA_DUOS_CTC) || defined (CONFIG_MACH_INFINITE_DUOS_CTC) || defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY)|| defined(CONFIG_MACH_KYLEPLUS_CTC) || defined(CONFIG_MACH_BAFFIN_DUOS_CTC) || defined(CONFIG_MACH_DELOS_DUOS_CTC)
	while(IS_ERR(filp)){
