...
defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_DELOS_OPEN)
...
defined(CONFIG_MACH_KYLEPLUS_CTC) || defined(CONFIG_MACH_DELOS_OPEN)
/* B1 mode */
...
#if defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_KYLEPLUS_OPEN) ||\
defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_DELOS_OPEN) && !defined(CONFIG_MACH_DELOS_OPEN)
/* B1.5 mode */
