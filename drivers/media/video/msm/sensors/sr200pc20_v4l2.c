...
//	rc = gpio_request(ARUBA_CAM_IO_EN, "aruba_a_en");
	...
	rc = gpio_request(FRONT_CAM_STBY, "front_cam_stby");
	rc = gpio_request(FRONT_CAM_RESET, "front_cam_reset");
...
//	gpio_set_value_cansleep(ARUBA_CAM_IO_EN, 0);
    ...
    printk("FRONT_CAM_C_EN = %d \n", gpio_get_value(FRONT_CAM_C_EN));
...
void sr200pc20_sensor_start_stream(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	SR200PC20_WRT_LIST(sr200pc20_Init_Reg);
