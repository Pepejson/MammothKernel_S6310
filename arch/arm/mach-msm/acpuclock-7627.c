...
static struct clkctl_acpu_speed pll0_960_pll1_245_pll2_1200_pll4_1008[] = {
	...
	{ 1, 800000, ACPU_PLL_4, 6, 0, 105500, 3, 6, 180000 },
	{ 1, 1008000, ACPU_PLL_4, 6, 0, 136000, 3, 7, 200000 },
        { 1, 1036800, ACPU_PLL_4, 6, 0, 139600, 3, 7, 208000 },
        { 1, 1056000, ACPU_PLL_4, 6, 0, 142000, 3, 7, 208000 },
        { 1, 1113600, ACPU_PLL_4, 6, 0, 149200, 3, 7, 208000 },
        { 1, 1152000, ACPU_PLL_4, 6, 0, 154000, 3, 7, 208000 },
        { 1, 1190400, ACPU_PLL_4, 6, 0, 158800, 3, 7, 208000 },
        { 1, 1228800, ACPU_PLL_4, 6, 0, 163600, 3, 7, 208000 },
        { 1, 1267200, ACPU_PLL_4, 6, 0, 168400, 3, 7, 216000 },
	{ 1, 1280000, ACPU_PLL_4, 6, 0, 170000, 3, 7, 216000 }, //Max for PLL
	{ 1, 1292800, ACPU_PLL_4, 6, 0, 175000, 3, 7, 216000 },
	{ 0 }
};
