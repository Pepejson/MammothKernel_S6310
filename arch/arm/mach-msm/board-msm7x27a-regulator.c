...
#if defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY)||defined(CONFIG_MACH_KYLEPLUS_OPEN)
...
#if defined(CONFIG_MACH_ARUBA_DUOS_CTC)	|| defined(CONFIG_MACH_INFINITE_DUOS_CTC) || defined(CONFIG_MACH_KYLEPLUS_CTC) || defined(CONFIG_MACH_BAFFIN_DUOS_CTC) || defined(CONFIG_MACH_DELOS_DUOS_CTC)
...
#if defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY)
...
#else
	PCOM_VREG_LDO(ldo19, 57, NULL, 1800000, 3000000, 0, -1, 0, 0, 0, 0, p),
#endif
